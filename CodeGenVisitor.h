...
public:
  ...
  antlrcpp::Any visitParams(AslParser::ParamsContext *ctx);
  antlrcpp::Any visitReturn(AslParser::ReturnContext *ctx);
  antlrcpp::Any visitFcall(AslParser::FcallContext *ctx);
  antlrcpp::Any visitIndex(AslParser::IndexContext *ctx);
